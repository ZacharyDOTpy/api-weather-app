...
// Applies text content to day 3 card
      document.getElementById('card1-date').textContent.dayjs(dateDay3).format('M/D/YYYY');
      document.getElementById('card1-icon').setAttribute('src', 'http://openweathermap.org/img/w/' + iconDay3 + '.png')
      document.getElementById('card1-temp').textContent = 'Temp: ' + tempDay3;
      document.getElementById('card1-wind').textContent = 'Wind: ' + windDay3;
      document.getElementById('card1-humid').textContent = 'Humidity: ' + humidDay3;
...
// Applies text content to day 4 card
      document.getElementById('card1-date').textContent.dayjs(dateDay4).format('M/D/YYYY');
      document.getElementById('card1-icon').setAttribute('src', 'http://openweathermap.org/img/w/' + iconDay4 + '.png')
      document.getElementById('card1-temp').textContent = 'Temp: ' + tempDay4;
      document.getElementById('card1-wind').textContent = 'Wind: ' + windDay4;
      document.getElementById('card1-humid').textContent = 'Humidity: ' + humidDay4;
...
// Applies text content to day 5 card
      document.getElementById('card1-date').textContent.dayjs(dateDay5).format('M/D/YYYY');
      document.getElementById('card1-icon').setAttribute('src', 'http://openweathermap.org/img/w/' + iconDay5 + '.png')
